...
//  thinkercap.prev = thinkercap.next  = &thinkercap;
    ...
    thinkercap.next_sptr = &thinkercap;
    thinkercap.prev_sptr = &thinkercap;
}
...
{
    getThinkerPrev(&thinkercap)->next_sptr = thinker;
    thinker->next_sptr = &thinkercap;
//  thinker->prev = thinkercap.prev;
    thinker->prev_sptr = thinkercap.prev_sptr;
    thinkercap.prev_sptr = thinker;
}
...
void P_RemoveThinkerDelayed(thinker_t *thinker)
{
    ...
    getThinkerPrev(thinker)->next_sptr = next;
    //Z_Free(thinker);
