...
//Whether the status bar will be forced to be refreshed on the next frame. It will automatically be set to false when done
    boolean forceSTRefresh;
