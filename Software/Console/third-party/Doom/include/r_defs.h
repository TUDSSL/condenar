...
typedef struct
{
    ...
    void* floordata_sptr;
    void* ceilingdata_sptr;   
    void* touching_thinglist_sptr;
    void* thinglist_sptr;
    void* soundtarget_sptr;

    short special;
    short oldspecial;     //jff 2/16/98 remembers if sector WAS secret (automap)
    short tag; 
    void* lines_ppptr;	// packed pointer to packed address
    uint8_t lightlevel;
} sector_t;

static inline mobj_t* getSectorThingList(sector_t *psec)
{
    return (mobj_t*) psec->thinglist_sptr;
}
static inline void* getSectorCeilingData(sector_t *psec)
{
    return (void*) psec->ceilingdata_sptr;
}
static inline void* getSectorFloorData(sector_t *psec)
{
    return (void*) psec->floordata_sptr;
}

static inline const struct line_s** getSectorLines(sector_t *psec)
{
    return (const struct line_s**)psec->lines_ppptr;
}
...
//  short *sprtopclip, *sprbottomclip;
    ...
    void* sprtopclip_ssptr;
    void* sprbottomclip_ssptr; // short pointer to short
...
#else
    return (spriteframe_t *)p_sd->spriteframes_sptr;
#endif
}
//
...
{
    return (msecnode_t*)pmobj->touching_sectorlist_sptr;
}
static inline mobj_t* getSectorSoundTarget(sector_t *ps)
{
    return (mobj_t*)(ps->soundtarget_sptr);
}
