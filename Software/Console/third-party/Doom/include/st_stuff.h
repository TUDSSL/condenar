...
// proff 08/18/98: Changed for high-res
#define ST_FACESX               (ST_X+109 * ST_C)
...
// proff 08/18/98: Changed for high-res
#define ST_AMMOX                (ST_X+31 * ST_C)
#define ST_AMMOY                (ST_Y+4)
//#define ST_AMMOX                44
//#define ST_AMMOY                171
...
// proff 08/18/98: Changed for high-res
#define ST_HEALTHX              (ST_X+65 * ST_C)
#define ST_HEALTHY              (ST_Y+4)

// Weapon pos.
// proff 08/18/98: Changed for high-res
#define ST_ARMSX                (ST_X+85 * ST_C)
...
// proff 08/18/98: Changed for high-res
#define ST_ARMORX               (ST_X+165 * ST_C)
#define ST_ARMORY               (ST_Y+4)
