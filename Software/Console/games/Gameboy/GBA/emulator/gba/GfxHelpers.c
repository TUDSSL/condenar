...
typedef TileLine (*TileReader) (const u16 *, const int, const u8 *, u16 *, const u32);
...
static inline TileLine gfx_tile_read(const u16 *screenSource, const int yyy, const u8 *charBase, u16 *palette, const u32 prio)
{
	TileEntry tile;
...
static inline TileLine gfx_tile_read_palette(const u16 *screenSource, const int yyy, const u8 *charBase, u16 *palette, const u32 prio)
{
	TileEntry tile;
	tile = READ16LE(screenSource);
